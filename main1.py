...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for animal in range(20):
            ...
            self.animal_sprite = arcade.Sprite("assets/{animal}.png".format(animal=animal), 0.5) #调用arcade.spritede的函数，第一个参数是assets/{animal}.png".format(animal=animal)，第二个参数是0.5
